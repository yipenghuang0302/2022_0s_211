...
def generate_test ( filenum, path="./" ):
    ...
    set_0_line_0_block = random.randrange(1<<8)
    ...
    while True:
        ...
        if set_0_line_0_tag != set_0_line_1_tag:
            break
    set_0_line_1_block = random.randrange(1<<8)

    set_1_line_0_valid = random.getrandbits(1)
    set_1_line_0_tag = random.getrandbits(1)
    set_1_line_0_block = random.randrange(1<<8)
    ...
    while True:
        ...
        if set_1_line_0_tag != set_1_line_1_tag:
            break
    set_1_line_1_block = random.randrange(1<<8)
